...
//
    ...
    private void setUsersByDepartmentSelected(Department departmentSelected) {
        ...
        if (departmentSelected.getUsers() != null) {
...
//        DataServices.sendData(AppConfig.GET_MY_USERS,null,requestQueue,AddNewTaskActivity.this,Constants.METHOD_GET,null);
    ...
    private void resetActivity() {
        ...
        new SweetAlertDialog(App.getContext(), SweetAlertDialog.SUCCESS_TYPE)
                .setTitleText("Task alert")
                .setContentText("The task was kept in the system")
                .setConfirmText("Ok!")
...
//                    public void onClick(SweetAlertDialog sDialog) {
////                        sDialog.dismissWithAnimation();
//                        Intent intent = new Intent(AddNewTaskActivity.this, AddNewTaskActivity.class);
